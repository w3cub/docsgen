...
repo_url = "git@github.com:w3cub/w3cub-release-202001.git"
...
task :multi_gen_deploy do 
  ...
  queueNames = 
[
'angular angularjs~1.7 ',
'angular~7 ansible~2.9 ',
...
'c cakephp~3.8 ',
'chai chef~12 ',
'clojure~1.9 cmake~3.15 ',
'codeception codeceptjs ',
'codeigniter~3 coffeescript~2 ',
'composer cordova~9 ',
'cpp crystal~0.31 ',
'css cypress ',
'd d3~5 ',
...
'haxe haxe~cpp ',
'haxe~cs haxe~flash ',
'haxe~hashlink haxe~java ',
'haxe~javascript haxe~lua ',
'haxe~neko haxe~php ',
'haxe~python haxe~sys ',
'homebrew html ',
'http immutable ',
'influxdata jasmine ',
'javascript jekyll ',
...
'liquid lodash~4 ',
'love lua~5.3 ',
'mariadb marionette~4 ',
'markdown matplotlib~3.1 ',
'meteor~1.5 minitest ',
'mocha modernizr ',
'moment mongoose ',
'nginx nginx_lua_module ',
'nim node ',
'node~10_lts node~4_lts ',
'node~6_lts node~8_lts ',
'nokogiri npm ',
'numpy~1.17 octave ',
'openjdk~8 openjdk~8_gui ',
'openjdk~8_web opentsdb ',
'padrino pandas~0.25 ',
'perl~5.26 phalcon~2 ',
'phalcon~3 phaser ',
'phoenix ',
...
'rethinkdb~ruby ruby~2.6 ',
'rust rxjs ',
'saltstack sass ',
'scala~2.12_library scala~2.12_reflection ',
'scala~2.13_library scala~2.13_reflection ',
