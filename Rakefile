...
repo_url = "git@github.com:w3cub/docshub-release-201902.git"
...
'cakephp~3.6 chai ',
'chef~12 clojure~1.9 ',
'cmake~3.12 codeception ',
'codeceptjs codeigniter~3 ',
'coffeescript~2 cordova~7 ',
'cordova~8 cpp ',
'crystal css ',
'd d3~4 ',
'd3~5 ',
...
'julia~1.0 knockout ',
'koa kotlin ',
'laravel~5.7 leaflet~1.3 ',
'less liquid ',
'lodash~4 love ',
'lua~5.3 marionette~4 ',
'markdown matplotlib~2.1 ',
'matplotlib~3.0 meteor~1.5 ',
'minitest mocha ',
'modernizr moment ',
'mongoose nginx ',
