...
repo_url = "git@github.com:w3cub/docshub-release-201704.git"
...
task :test_preview do |t, args|
  Rake::Task[:copy_html].invoke('angular~4_typescript backbone underscore bower node bottle~0.12')
...
task :multi_gen_deploy do 
  ...
  queueNames = 
[
# 'angularjs~1.2 angularjs~1.3 ',
# 'angularjs~1.4 angularjs~1.5 ',
# 'angularjs~1.6 angular~2_typescript ',
# 'angular~4_typescript ansible ',
# 'apache_http_server apache_pig~0.13 ',
# 'apache_pig~0.14 apache_pig~0.15 ',
# 'apache_pig~0.16 async ',
# 'backbone bootstrap~3 ',
# 'bootstrap~4 bottle~0.11 ',
# 'bottle~0.12 bower ',
# 'browser_support_tables c ',
# 'cakephp~2.7 cakephp~2.8 ',
# 'cakephp~2.9 cakephp~3.1 ',
# 'cakephp~3.2 cakephp~3.3 ',
# 'cakephp~3.4 chai ',
# 'chef~11 chef~12 ',
# 'clojure~1.7 clojure~1.8 ',
# 'cmake~3.5 cmake~3.6 ',
# 'cmake~3.7 codeception ',
# 'codeceptjs codeigniter~3 ',
# 'coffeescript cordova~6 ',
# 'cpp crystal ',
# 'css d3~3 ',
# 'd3~4 django~1.10 ',
# 'django~1.8 django~1.9 ',
# 'docker~1.10 docker~1.11 ',
# 'docker~1.12 docker~1.13 ',
# 'dojo dom ',
# 'dom_events drupal~7 ',
# 'drupal~8 elixir~1.3 ',
# 'elixir~1.4 ember ',
...
# 'haxe~python html ',
# 'http immutable ',
# 'influxdata javascript ',
# 'jquery jquerymobile ',
# 'jqueryui julia ',
# 'knockout kotlin ',
# 'laravel~5.1 laravel~5.2 ',
# 'laravel~5.3 laravel~5.4 ',
# 'less lodash~2 ',
# 'lodash~3 lodash~4 ',
# 'love lua~5.1 ',
# 'lua~5.2 lua~5.3 ',
...
# 'matplotlib~2.0 meteor~1.3 ',
# 'meteor~1.4 minitest ',
# 'mocha modernizr ',
# 'moment mongoose ',
# 'nginx nginx_lua_module ',
# 'node node~4_lts ',
# 'node~6_lts nokogiri ',
# 'npm numpy~1.10 ',
# 'numpy~1.11 numpy~1.12 ',
# 'opentsdb padrino ',
# 'pandas~0.18 pandas~0.19 ',
# 'perl~5.20 perl~5.22 ',
# 'perl~5.24 phalcon~2 ',
# 'phalcon~3 phaser ',
# 'phoenix php ',
