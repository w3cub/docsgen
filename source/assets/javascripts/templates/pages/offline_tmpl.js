...
var canICloseTheTab = function() {
  if (app.AppCache.isEnabled()) {
    ...
    return " Yes! Even offline, you can open the app and everything will work as if you were online (provided you installed all the documentations you want to use beforehand). ";
  } else {
