...
const sidebarFooter = html => `<div class="_sidebar-footer">${html}</div>`;

templates.sidebarSettings = () => sidebarFooter(`\
...
templates.sidebarSave = () => sidebarFooter("<a class=\"_sidebar-footer-link _sidebar-footer-save\" role=\"button\">Save</a>");
