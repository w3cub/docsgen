...
(function() {
  ...
  const Cls = (app.views.SearchScope = class SearchScope extends app.View {
    ...
    constructor(el) { this.onResults = this.onResults.bind(this);     this.reset = this.reset.bind(this);     this.onKeydown = this.onKeydown.bind(this);     this.afterRoute = this.afterRoute.bind(this);     this.el = el; super(...arguments); }
    ...
    onKeydown(event) {
      if (event.which === 8) { // backspace
        ...
        if ((event.which === 9) || // tab
           ((event.which === 32) && (app.isMobile() || $.isTouchScreen()))) { // space
