...
repo_url = "git@github.com:w3cub/docshub-release-201802.git"
...
task :test_preview do |t, args|
  Rake::Task[:copy_html].invoke('jekyll eslint jsdoc webpack babel')
...
'less liquid ',
'lodash~4 love ',
'lua~5.3 marionette~2 ',
'marionette~3 markdown ',
'matplotlib~2.1 meteor~1.5 ',
'minitest mocha ',
'modernizr moment ',
'mongoose nginx ',
