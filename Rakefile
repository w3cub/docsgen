...
'cakephp~4.1 chai ',
'chef~12 clojure~1.10 ',
'cmake~3.19 codeception ',
'codeceptjs codeigniter~4 ',
'coffeescript~2 composer ',
'cordova~9 cpp ',
'crystal css ',
'cypress d ',
'd3~5 dart~2 ',
'django_rest_framework django~1.11 ',
'django~2.2 django~3.1 ',
'docker~19 dojo ',
'dom dom_events ',
'drupal~8 electron ',
'elisp elixir~1.11 ',
...
'gcc~10 gcc~10_cpp ',
'git gnu_cobol ',
'gnu_fortran~10 gnuplot ',
'go godot~3.2 ',
'graphite grunt ',
'handlebars haskell~7 ',
'haskell~8 haxe ',
'haxe~cpp haxe~cs ',
'haxe~eval haxe~flash ',
