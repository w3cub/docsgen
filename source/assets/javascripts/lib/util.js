...
$.isWindows = () => (navigator.platform != null ? navigator.platform.indexOf('Win') : undefined) >= 0;
...
const requestAnimFrame = ((() => window.requestAnimationFrame || window.webkitRequestAnimationFrame || function(callback) {
